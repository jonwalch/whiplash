        ...
        <article>
          <header className="article__header">
            <div className="article__container">
              ...
              <h3 className="h3">What is Whiplash?</h3>
          ...
          <div className="article__container">
            ...
            <h3 className="h3">How do I play?</h3>
            ...
            <h3 className="h3">How are odds and payouts calculated?</h3>
            ...
            <h3 className="h3">How can I chat with other Whiplash users?</h3>
            {/* TODO: real link for this discord*/}
            <p>Join our <a href="whiplashesports.com">Discord server</a>!</p>
            <h3 className="h3">How does Whiplash decide which stream to play?</h3>
            <p>We play the most popular esports CS:GO match on Twitch.</p>
            <h3 className="h3">Why can’t I see the embedded Twitch chat?</h3>
            <p>You need to allow third party cookies in your browser settings.</p>
            <h3 className="h3">Why didn’t I get a verification email?</h3>
